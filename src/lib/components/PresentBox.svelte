<script lang="ts">
	...
	let { children, withRibbon = true }: Props = $props()
</script>

<div class="present" class:withRibbon>
	{#if withRibbon}
		<svg
			...
			class="ribbon"
		>
			<g style="fill:#ffceff;stroke:#ffeaff;fill-opacity:1;stroke-width:.75;stroke-linejoin:round">
				<path
